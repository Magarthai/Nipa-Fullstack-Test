...
router.put('/updateStatustickets/:parameter', authMiddleware,isAdmin, updateStatusTicket);
router.put('/closetickets/:parameter', authMiddleware,isAdmin, closeTicket);
