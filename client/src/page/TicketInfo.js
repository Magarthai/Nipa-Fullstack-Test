        ...
        <div className="ticket-info-container">
          <div className="ticket-info">
            <div className="ticket-info-img-container">
              {data && (
                <h1 style={{ marginBottom: -20 }}>{data.selectTopic}</h1>
              )}
            </div>
            ...
            <div className="ticket-info-text">
              ...
              (data.status === "pending" || data.status === "accepted") ? (
                <textarea
                  ...
                  className="solvedetail extralight"
                  name="solve detail"
                ></textarea>
              ) : (
                <div className="solvedetail">
                  <p>{data && data.solve}</p>
                </div>
              )}
